...
bool VulkanApplication::CheckInstanceExtensionSupport(const std::vector<const char*>& required_extensions)
{
...
void VulkanApplication::SetupDebugManager()
{
...
VKAPI_ATTR VkBool32 VKAPI_CALL VulkanApplication::DebugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT message_severity, VkDebugUtilsMessageTypeFlagsEXT message_type, const VkDebugUtilsMessengerCallbackDataEXT* callback_data, void* user_data)
{
...
bool VulkanApplication::CheckDeviceRequirements(VkPhysicalDevice device)
{
...
VkImageView VulkanApplication::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspect_flags, uint32_t num_mips)
{
...
void VulkanApplication::PopulateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& create_info)
{
    create_info = {};
...
void VulkanApplication::EndSingleTimeCommands(VkCommandBuffer command_buffer)
{
...
uint32_t VulkanApplication::FindMemoryType(uint32_t type_filter, VkMemoryPropertyFlags properties)
{
...
void VulkanApplication::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& out_buffer, VkDeviceMemory& out_buffer_memory)
{
...
void VulkanApplication::CreateImage(uint32_t width, uint32_t height, uint32_t num_mips, VkSampleCountFlagBits num_samples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& image_memory)
{
...
void VulkanApplication::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout old_layout, VkImageLayout new_layout, uint32_t num_mips)
{
    VkCommandBuffer command_buffer = BeginSingleTimeCommands();
...
void VulkanApplication::GenerateMipmaps(VkImage image, VkFormat image_format, int32_t tex_width, int32_t tex_height, uint32_t num_mips)
{
...
VkSampleCountFlagBits VulkanApplication::GetMaxNumSamples()
{
...
void VulkanApplication::UpdateUniformData(uint32_t current_swap_chain_img_idx)
{
